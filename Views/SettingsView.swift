    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                // Статус-панель (Glassmorphism)
                VStack(spacing: 0) {
                    NetworkStatusRowGlass(
                        icon: "server.rack",
                        title: "HQ Сервер",
                        status: meshManager.connectionState == .connected ? "В сети" : "Поиск Штаба",
                ...
                Button(action: { 
                    ...
                    .padding(18)
                    .background(Color.white.opacity(0.05).background(Material.ultraThinMaterial))
                    .cornerRadius(20)
